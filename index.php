...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    &nbsp
                    <li class="nav-item">
                        <button class="btn btn-primary" style="--bs-btn-focus-shadow-rgb:none;" type="submit"
                            data-bs-toggle="modal" data-bs-target="#exampleModal">ADD Faculty</button>
                    </li>
                </ul>
                    ...
                    <form method="POST" class="border p-3 rounded-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col mb-3">
                                ...
                                <input type="text" class="form-control" name="Name" id="Name" pattern="[A-z]{3,20}"
                                    required>
                            </div>
                            <div class="col mb-3">
                                <label for="LastName" class="form-label">father's name</label>
                                <input type="text" class="form-control" name="Surname" id="Surname"
                                    pattern="[A-z]{3,20}" required>
                            </div>
                            <div class="col mb-3">
    ...
    <div class="modal fade" id="updatexampleModal" tabindex="-1" aria-labelledby="updatexampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" style="--bs-modal-width: 590px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" class="border border p-3 rounded-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col mb-3">
                                <label for="LastName" class="form-label">Surname</label>
                                <input type="text" class="form-control" name="updateFatherName" id="updateFatherName"
                                    pattern="[A-z]{3,20}" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="MobileNumber">Mobile Number</label>
                                <input type="tel" class="form-control" name="updateMobileNumber" id="updateMobileNumber"
                                    pattern="[0-9]{10}" required>
                                <div class="form-text"></div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function getDetails(details) {
            ...
            $('#hiddendata').val(details.No);

            $('#updateTitle option:selected').text(details.Title);
            $('#updateName').val(details.Name);
            $('#updateSurname').val(details.father_name);
            $('#updateFatherName').val(details.Surname);
            $('#updateEmail').val(details.Email_ID);
            $('#updateDepartment option:selected').text(details.Department);
            $('#updateAddress').val(details.Address);
            $('#updateMobileNumber').val(details.MobileNumber);
            $('#updatexampleModal').modal('show');
